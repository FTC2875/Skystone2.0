...
public class LiftController2 {
    private DcMotor lift1;
    private int liftstage = 0;
    private Telemetry telemetry;

    private int[] stagepos = {0, 100, 200, 300, 400, 500, 600, 700}; //change endcoder values
    ...
    public LiftController2(DcMotor lift1, Telemetry telemetry) {
        this.lift1 = lift1;
